...
public class PreferenceConfiguration {
    ...
    public static final String LIST_VIEW_PREF_STRING = "checkbox_list_view";
    public static final String IMMERSIVE_MODE_PREF_STRING = "checkbox_immersive_mode";
    ...
    public boolean listView, immersiveMode;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.listView = prefs.getBoolean(LIST_VIEW_PREF_STRING, false);
        config.immersiveMode = prefs.getBoolean(IMMERSIVE_MODE_PREF_STRING, true);
