...
public class AbsoluteTouchContext implements TouchContext {
    ...
    public void setPointerCount(int pointerCount) {
        // We no longer cancel Finger 1 when a second finger is detected.
        // This allows multitouch virtual controls to work while Finger 1
        // is being used for mouse emulation.
    }
}
