...
public abstract class VirtualControllerElement extends View {
    ...
    protected int _dynamicStickType = 0; // 0 = Left Stick, 1 = Right Stick
    ...
    public void setDynamicMode(boolean dynamicMode) {
        _isDynamicMode = dynamicMode;
        invalidate();
    }

    public boolean isDynamicMode() {
        return _isDynamicMode;
    }

    public void setDynamicStickType(int type) {
        _dynamicStickType = type;
        invalidate();
    }

    public int getDynamicStickType() {
        return _dynamicStickType;
    }
