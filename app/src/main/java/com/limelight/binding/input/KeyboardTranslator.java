...
public class KeyboardTranslator implements InputManager.InputDeviceListener {
    ...
    public static final int VK_PLUS = 187; // VK_OEM_PLUS
    public static final int VK_MINUS = 189; // VK_OEM_MINUS
    public static final int VK_COMMA = 188; // VK_OEM_COMMA
    public static final int VK_PERIOD = 190; // VK_OEM_PERIOD
    public static final int VK_CLOSE_BRACKET = 221; // VK_OEM_6
    public static final int VK_OPEN_BRACKET = 219; // VK_OEM_4
    public static final int VK_SEMICOLON = 186; // VK_OEM_1
    public static final int VK_SLASH = 191; // VK_OEM_2
    public static final int VK_BACK_SLASH = 220; // VK_OEM_5
    public static final int VK_QUOTE = 222; // VK_OEM_7
    public static final int VK_GRAVE = 192; // VK_OEM_3
    public static final int VK_SPACE = 32;
    public static final int VK_PRINTSCREEN = 44; // VK_SNAPSHOT
    ...
    public short translate(int keycode, int deviceId) {
        ...
        if (keycode >= KeyEvent.KEYCODE_0 &&
        ...
        else if (keycode >= 183 && keycode <= 194) { // KEYCODE_F13 to KEYCODE_F24
            translated = (keycode - 183) + VK_F13;
        }
        else if (keycode == 160) { // KEYCODE_NUMPAD_ENTER
            translated = 0x0d;
        }
        else {
            switch (keycode) {
            ...
            case KeyEvent.KEYCODE_FORWARD_DEL:
                translated = VK_DELETE;
                break;
                
            case KeyEvent.KEYCODE_INSERT:
                translated = VK_INSERT;
                break;
                
            case KeyEvent.KEYCODE_LEFT_BRACKET:
                translated = VK_OPEN_BRACKET;
                break;
