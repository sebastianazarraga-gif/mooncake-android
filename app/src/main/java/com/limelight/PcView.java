...
public class PcView extends Activity implements AdapterFragmentCallbacks {
        ...
        if (gridToggle != null) {
            ...
            gridToggle.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    v.setActivated(isListView);

                    PreferenceManager.getDefaultSharedPreferences(PcView.this)
                            .edit()
                            .putBoolean(PreferenceConfiguration.LIST_VIEW_PREF_STRING, isListView)
                            .apply();

                    // Update the adapter layout
                    pcGridAdapter.setLayoutId(isListView ? R.layout.pc_list_item : R.layout.pc_grid_item);

                    // Reload the fragment with the new container
    ...
    protected void onResume() {
        ...
        UiHelper.updateLastActivity(this);
        UiHelper.setupBottomNav(this, 0);
        UiHelper.applyImmersiveMode(this);
    ...
    public int getAdapterFragmentLayoutId() {
        return isListView ? R.layout.pc_list_view : R.layout.pc_grid_view;
    }
